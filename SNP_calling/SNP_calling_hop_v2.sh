...
for Strain in S1 S3; do
  for filename in /projects/hop/archive_raw_data/trim/$Strain/alignment_2021; do #filename is the pathway specified after "in"
   echo $Strain
...
Reference=../../projects/hop/cascade_2021/cascadePrimary.fasta  
for Strain in S1 S3; do
  for input in ../../projects/hop/raw_data/trim/$Strain/alignment_2021/nomulti/corrected_bam/"$Strain"_realigned.bam; do
    echo $Strain
...
##mkdir pileup_calls
##cp /projects/hop/SNP_calling/haplotype_calls/$strain/*.g.vcf /projects/hop/SNP_calling/haplotype_calls/pileup_calls
##cp /projects/hop/raw_data_cascade/cascadePrimary.fasta cascadePrimary.dict cascadePrimary.fasta.fai /projects/hop/SNP_calling/haplotype_calls

##-------------------------------8. Run GenotypeGVCF and VariantsToAllelicPrimitives on g.vcf file generated from previous step (gatk) ----------------
## filter for only biallelic SNPs. 

#need to test if below script works 
```bash
...
output=/projects/hop/SNP_calling/haplotype_calls_v2/hop_joint/hop_joint_SNPs_genotype.vcf
output2=/projects/hop/SNP_calling/haplotype_calls_v2/hop_joint/hop_joint_SNPs_genotype_2.vcf
